          ...
          <Grid item xs={12} sm={6}>
            <div className={classes.box}>
              <div className={classes.home}>
                ...
                <div className={classes.homeLine}></div>
                <div className={classes.homeLine2}></div>
              </div>
              <div className={classes.pad}>
                <div className={classes.choose}>
                  Login through one of the following methods
                </div>
                <div className={classes.welcome}>Welcome to Mentor Codes</div>
                <div className={classes.remember}>
                  Please remember the singin method as only one email is
